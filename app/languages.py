...
data = {
    "it": {
        ...
        "index_label2": "Siamo il luogo dove le idee di designer internazionali trovano il modo di essere realizzate grazie alle abilità artigiane dei migliori makers italiani.",
        "index_btn1": "Voglio saperne di più",
        "index_title3": "La nostra mission",
        "index_label3-1": "Mettere in contatto persone che cercano prodotti unici e di qualità con i migliori makers del Made in Italy, ad un prezzo equo, favorendo cosi lo sviluppo dell'artigianato digitale.",
        "index_label3-2": "Valorizziamo la creatività di designers internazionali e il territorio di makers italiani offrendo tecnologia, formazione, strumenti di marketing e supporto logistico per promuovere il loro business",
        ...
        "index_lbl_designer": "Trasformiamo le tue creazioni in oggetti per i nostri clienti, valorizzando le tue opere digitali.",
        "index_maker": "Maker",
        ...
        "maker_designer_title2": "Verifichiamo i tuoi file",
        "maker_designer_label2": "Ogni modello è verificato e reso idoneo alla stampa.",
        "maker_designer_title3": "Guadagna con la tua idea",
        "maker_designer_label3": "Un singolo upload, una vetrina infinita e gratuita.",
        "maker_title5": "Rendiamo la tua idea riproducibile e redditizia",
        "maker_label5-1": "Saremo la tua vetrina agli occhi del mondo, proteggendo le tue idee e garantendoti che solo i migliori makers avranno accesso ai tuoi modelli 3D per soddisfare i clienti.",
        "maker_label5-2": "Il marketplace è pensato per diffondere e vedere realizzate le idee di voi designers. Carica i tuoi modelli 3D, inserisci informazioni utili per riprodurli fedelmente e imposta un prezzo per il singolo uso commerciale. I nostri algoritmi faranno il resto.",
    ...
    "en": {
        ...
        "maker_designer_title2": "We check your files",
        "maker_designer_label2": "We offer assistance in case your files are not printable",
        "maker_designer_title3": "Earn money from your idea",
        "maker_designer_label3": "Explore your potential, we are here to assist you",
        "maker_title5": "Our marketplace is designed to make your idea repeatable and profitable",
        ...
        "maker_label5-2": "Upload your 3D models, enter useful information to reproduce them as you intended them and set a price for single commercial use. Our algorithms will offer customers the best craftsmen able to faithfully reproduce them. A marketplace built to spread and see your idea realized.",
    ...
    "fr": {
        ...
        "maker_designer_title2": "Nous vérifions vos fichiers",
        "maker_designer_label2": "Nous offrons une assistance au cas où vos fichiers ne seraient pas imprimables",
        "maker_designer_title3": "Gagner de votre idée",
        "maker_designer_label3": "Explorez votre potentiel, nous sommes là pour vous aider",
        "maker_title5": "Tamatara est conçu pour rendre votre idée reproductible et rentable",
        ...
        "maker_label5-2": "Upload vos modèles 3D, saisissez des informations utiles pour les reproduire comme vous les avez voulus et fixez un prix pour un usage commercial unique. Nos algorithmes offriront aux clients les meilleurs artisans capables de les reproduire fidèlement. Un marché conçu pour se propager et voir votre idée se concrétiser.",
