...
data = {
    "it": {
        ...
        "maker_designer_label2": "Offriamo assitenza se i tuoi file non sono adatti alla stampa 3D.",
        "maker_designer_title3": "Guadagna dalla tua idea",
        "maker_designer_label3": "Esplora il tuo potenziale, siamo qui per assisterti.",
        ...
        "maker_label5-2": "Carica i tuoi modelli 3D, inserisci informazioni utili per riprodurli come tu li hai pensati e imposta un prezzo per il singolo uso commerciale. I nostri algoritmi proporranno ai clienti i migliori artigiani in grado di riprodurli fedelmente. Un marketplace costruito per diffondere e vedere realizzata la tua idea.",
